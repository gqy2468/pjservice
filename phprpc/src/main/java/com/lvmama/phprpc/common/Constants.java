...
public class Constants {
    ...
    public static final String  THRIFT_PROPERTIES_KEY               = "thrift.properties.file";

    public static final String  DEFAULT_THRIFT_PROPERTIES           = "thrift.properties";
    ...
    public static final String  DEFAULT_REMOTING_CODEC             = "thrift";
    ...
    public static final String  DEFAULT_REGISTRY                   = "thrift";
    ...
    public static final String  DEFAULT_PROMPT                     = "thrift>";
    ...
    public static final String  THRIFT_VERSION_KEY                  = "thrift";
    ...
    @Deprecated
    public static final String  SHUTDOWN_WAIT_SECONDS_KEY          = "thrift.service.shutdown.wait.seconds";

    public static final String  SHUTDOWN_WAIT_KEY                  = "thrift.service.shutdown.wait";
    ...
    public static final String  STUB_EVENT_KEY                     = "thrift.stub.event";

    public static final boolean DEFAULT_STUB_EVENT                 = false;

    public static final String  STUB_EVENT_METHODS_KEY             = "thrift.stub.event.methods";
