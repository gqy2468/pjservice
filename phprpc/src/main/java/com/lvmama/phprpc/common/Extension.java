 ...
 * <p />
 * 扩展点声明配置文件，格式修改。<br />
 * 以Protocol示例，配置文件META-INF/thrift/com.xxx.Protocol内容：<br />
 * 由<br/>
 ...
 * 如果三方库不存在，会导致类初始化失败，
 * Extension标识thrift就拿不到了，异常信息就和配置对应不起来。
 * <br/>
 * 比如:
 * Extension("mina")加载失败，
 ...
 * 而不是报加载扩展点失败，以及失败原因。
 * 
 * @deprecated 因为含义广泛废弃，改用功 {@link com.lvmama.phprpc.common.extension.SPI}
