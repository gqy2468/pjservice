 ...
 */
package com.lvmama.phprpc.rpc.proxy.wrapper;
        ...
        if (GenericService.class != invoker.getInterface()) {
            ...
            if (ConfigUtils.isNotEmpty(stub)) {
                ...
                try {
                    ...
                    LOGGER.error("Failed to create stub implemention class " + stub + " in consumer " + NetUtils.getLocalHost() + " use thrift version 0.9.1, cause: " + t.getMessage(), t);
                    // ignore
                }
            }
        }
